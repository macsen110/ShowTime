    ...
    *****/
    ...
    return {
        ...
        showPrompt: function (message, cb) {
            var tpl = '<div class="widget-prompt">'+message+'</div>';
            if($('.widget-prompt').length > 0){
                $('.widget-prompt').remove();
        ...
        startLoading: function () {
            if (document.querySelector('.widget-loading')) return;
            var tpl = '<div class="widget-loading" id="layout_loading">'+
                        '<div class="mask"></div>'+
        ...
        endLoading: function () {
            var loadingDom = document.querySelector('.widget-loading');
            if (loadingDom) {
