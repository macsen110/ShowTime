...
/***/ function(module, exports, __webpack_require__) {
	...
	var _styleCss = __webpack_require__(172);
	...
	var WrapTimer = (function (_Component) {
		...
		_createClass(WrapTimer, [{
			...
			value: function render() {
				...
				var timer = alltime > 0 ? _react2['default'].createElement(Timer, { secondsRemaining: alltime }) : '';
				console.log(timer);
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'li',
							null,
							_react2['default'].createElement('input', { placeholder: 'day', 'data-name': 'day', className: 'ipt' })
						),
						_react2['default'].createElement(
							'li',
							null,
							_react2['default'].createElement('input', { placeholder: 'hour', 'data-name': 'hour', className: 'ipt' })
						),
						_react2['default'].createElement(
							'li',
							null,
							_react2['default'].createElement('input', { placeholder: 'minute', 'data-name': 'minute', className: 'ipt' })
						),
						_react2['default'].createElement(
							'li',
							null,
							_react2['default'].createElement('input', { placeholder: 'second', 'data-name': 'second', className: 'ipt' })
						),
						_react2['default'].createElement(
							'li',
							null,
							_react2['default'].createElement('input', { className: 'btn', onClick: this.saveTimer, value: 'Set' })
						)
					),
					timer
				);
