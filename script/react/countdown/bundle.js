...
/***/ function(module, exports, __webpack_require__) {
	...
	************** */
	...
	var _styleCss = __webpack_require__(174);

	var _styleCss2 = _interopRequireDefault(_styleCss);

	var WrapTimer = (function (_Component) {
		function WrapTimer(props, context) {
			_classCallCheck(this, WrapTimer);

			_get(Object.getPrototypeOf(WrapTimer.prototype), 'constructor', this).call(this, props, context);
			this.state = {
				alltime: null
			}
		...
		_inherits(WrapTimer, _Component);

		_createClass(WrapTimer, [{
			key: 'saveTimer',
			...
			value: function render() {
				...
				var timer = alltime > 0 ? _react2['default'].createElement(Timer, { toParent: function () {
						return _this.toParent();
					}, secondsRemaining: alltime }) : '';
				return _react2['default'].createElement(
					'div',
					{ className: 'wrap-timer' },
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'li',
							null,
							_react2['default'].createElement('input', { placeholder: 'day', 'data-name': 'day', className: 'ipt', defaultValue: '1' })
						),
						_react2['default'].createElement(
							'li',
							null,
							_react2['default'].createElement('input', { placeholder: 'hour', 'data-name': 'hour', className: 'ipt', defaultValue: '1' })
						),
						_react2['default'].createElement(
							'li',
							null,
							_react2['default'].createElement('input', { placeholder: 'minute', 'data-name': 'minute', className: 'ipt', defaultValue: '1' })
						),
						_react2['default'].createElement(
							'li',
							null,
							_react2['default'].createElement('input', { placeholder: 'second', 'data-name': 'second', className: 'ipt', defaultValue: '1' })
						),
						_react2['default'].createElement(
							'li',
							null,
							_react2['default'].createElement('input', { className: 'btn', onClick: function () {
									return _this.saveTimer();
								}, defaultValue: 'Set' })
						)
					),
					timer
	...
	var Timer = (function (_Component2) {
		function Timer(props, context) {
			...
			_get(Object.getPrototypeOf(Timer.prototype), 'constructor', this).call(this, props, context);
		...
		_createClass(Timer, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'ul',
						{ className: _styleCss2['default'].timer_container },
						leftTime.dd > 0 ? _react2['default'].createElement(
							'li',
							{ className: 'item day' },
							_react2['default'].createElement(
								'span',
						...
						leftTime.hh > 0 ? _react2['default'].createElement(
							'li',
							{ className: 'item hour' },
							_react2['default'].createElement(
								'span',
						...
						leftTime.mm > 0 ? _react2['default'].createElement(
							'li',
							{ className: 'item minute' },
							_react2['default'].createElement(
								'span',
								{ className: 'text' },
								leftTime.mm
						...
						leftTime.ss > 0 ? _react2['default'].createElement(
							'li',
					...
					_react2['default'].createElement(
						'p',
						{ onClick: this.props.toParent },
						'child comminute to parent'
					)
				);
			}
		}], [{
	...
	_reactDom2['default'].render(_react2['default'].createElement(WrapTimer, null), document.getElementById('Timer'));
...
/***/ function(module, exports) {
	...
	module.exports = {"timer_container":"style__timer_container___1IK_W"};
