...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(MyComponent, null), document.getElementById('hello-react'));
	...
	var Zoo = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      ' ',
	      React.createElement('input', { ref: 'giraffe' })
	    );
	  },
	...
	ReactDOM.render(React.createElement(Zoo, null), document.getElementById('refs'));
